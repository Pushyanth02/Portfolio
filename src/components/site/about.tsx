      ...
      <div className="wrap about-grid">
        <div className="about-copy">
          ...
          <p className="reveal" style={{ "--d": ".1s" } as React.CSSProperties}>
            I&apos;m Pushyanth — a computer science student &amp; software
            crafter who builds with AI and keeps his systems explainable. Days
            go to data structures &amp; algorithms; evenings go to full-stack
            builds with Claude, Codex &amp; friends in the loop; curiosity goes
            to AI/ML and cloud — studied hands-first, explained always.
          </p>
          <p className="reveal" style={{ "--d": ".2s" } as React.CSSProperties}>
            When I&apos;m not shipping, I&apos;m exploring open-source repos,
            chasing new AI tooling, and bringing the interesting bits back into
            my own projects.
          </p>
          <ul
